...
// modifiche cmdb inizio
			html += "<label class='controls-table-label'>" + key + "</label>";
//    		if (key=='GlobalId'){
//				html += "<label class='controls-table-label'>Global Id</label>";
//				//alert("Global Id: " + value);
//				$('td#cmdb_globalid').html(value);
//			}else{
//				if (key=='Name'){
//					//alert(key+": "+value);
//					$('td#cmdb_description').html(value);	
//				}
//				if (key=='ifcType'){
//					$('td#cmdb_ifctype').html(value);	
//				}
//				html += "<label class='controls-table-label'>" + key + "</label>";
//			}
// modifiche cmdb fine			
...
// modifica cmdb inizio
			$('td#cmdb_oid').html(id);
			oidOggettoDaSpostare = id;
			getOIDcoordinates();
			getObjectGUID();
			getObjectIfcType();
			getObjectName();
...
// modifica cmdb inizio
		document.getElementById('cmdb_ifcobject').style.display = 'inline';
// modifica cmdb fine
